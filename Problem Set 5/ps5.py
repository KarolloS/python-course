...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for c in string.ascii_lowercase:
            shift_dict[c] = string.ascii_lowercase[(string.ascii_lowercase.index(c) + shift) % 26]
        for c in string.ascii_uppercase:
            shift_dict[c] = string.ascii_uppercase[(string.ascii_uppercase.index(c) + shift) % 26]
        return shift_dict
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(26):
            counter = 0
            d_mes = Message.apply_shift(self, s)
            d_mes = d_mes.split(' ')
